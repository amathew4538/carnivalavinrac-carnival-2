...
controller.left.onEvent(ControllerButtonEvent.Pressed, function () {
    if (selectorIcon.x == 130) {
        selectorIcon.setPosition(80, 60)
    } else if (selectorIcon.x == 80) {
        selectorIcon.setPosition(30, 60)
    }
})
...
moleAWhackSelector = sprites.create(img`
    . . . . . . . . . . . . . . . . 
    . . . . . . . . . . . . . . . . 
    . . . . . . . . . . . . . . . . 
    . . . . . . . . . . . . . . . . 
    ...
    f f e e e e f f f f e f . . f f 
    e e e e e e e e e e e e f f e e 
    `, SpriteKind.Food)
scaling.scaleToPercent(moleAWhackSelector, 250, ScaleDirection.Uniformly, ScaleAnchor.Middle)
moleAWhackSelector.setPosition(30, 60)
targetPracticeSelector = sprites.create(img`
    . . . . . . f f f f . . . . . . 
    . . . . f f 2 2 2 2 f f . . . . 
    . . . f 2 2 1 1 1 1 2 2 f . . . 
    . . f 2 1 1 2 2 2 2 1 1 2 f . . 
    . f 2 1 1 2 2 1 1 2 2 1 1 2 f . 
    . f 2 1 2 2 1 2 2 1 2 2 1 2 f . 
    f 2 1 2 2 1 2 1 1 2 1 2 2 1 2 f 
    f 2 1 2 1 2 1 2 2 1 2 1 2 1 2 f 
    f 2 1 2 1 2 1 2 2 1 2 1 2 1 2 f 
    f 2 1 2 2 1 2 1 1 2 1 2 2 1 2 f 
    . f 2 1 2 2 1 2 2 1 2 2 1 2 f . 
    . f 2 1 1 2 2 1 1 2 2 1 1 2 f . 
    ...
    . . . . . . f f f f . . . . . . 
    `, SpriteKind.Food)
scaling.scaleToPercent(targetPracticeSelector, 250, ScaleDirection.Uniformly, ScaleAnchor.Middle)
targetPracticeSelector.setPosition(80, 60)
bottleStackSelector = sprites.create(img`
    . . . . . . . . . . . . . . . . 
    . . . . . f f f f f f . . . . . 
    . . . . . f 1 1 1 1 f . . . . . 
    . . . . . . f 1 1 f . . . . . . 
    ...
    f 1 8 8 8 f 8 f 8 8 8 8 f . . . 
    f 1 8 8 f 8 8 f 8 8 8 8 f . . . 
    . f f f f f f f f f f f f . . . 
    `, SpriteKind.Food)
scaling.scaleToPercent(bottleStackSelector, 250, ScaleDirection.Uniformly, ScaleAnchor.Middle)
bottleStackSelector.setPosition(130, 60)
selectorIcon = sprites.create(img`
    555............555
    5................5
    5................5
    ..................
